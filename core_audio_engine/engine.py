...
def run_pipeline(
    ...
    *,
    ...
    try:
        ...
        result = model.transcribe(str(combined_path), word_timestamps=True, language="en")
    ...
    available_sfx = ["applause", "laugh", "dramatic", "cash", "shock",
    ...
    from core_audio_engine.enhance import master_audio
